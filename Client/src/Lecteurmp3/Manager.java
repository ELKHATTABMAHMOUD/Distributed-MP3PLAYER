...
public interface Manager extends com.zeroc.Ice.Object
{
    ...
    int[] printstring(String chaine, com.zeroc.Ice.Current current);
    ...
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_printstring(Manager obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        String iceP_chaine;
        iceP_chaine = istr.readString();
        inS.endReadParams();
        int[] ret = obj.printstring(iceP_chaine, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
